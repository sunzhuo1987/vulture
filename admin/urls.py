...
urlpatterns = patterns('',
  ...
  (r'^app/check_availability/$',             'vulture.views.check_availability_app'),
  ...
  (r'^blackip/$',                              'vulture.views.vulture_object_list_adm', dict({'queryset': BlackIP.objects.all().order_by('app')}, template_name='vulture/generic_list.html', extra_context = dict(category='Black IP', name='BlackIP', url='/blackip', noname=True, fields=(('app','Application'), ('ip','IP'))))),
