...
urlpatterns = patterns('',
  ...
  (r'^security/$',                            'vulture.views.vulture_object_list_adm',dict({'queryset': ModSecConf.objects.all()},template_name='vulture/generic_list.html',extra_context = dict(category='Web Firewall', name='Configuration', url='/security', fields=(('motor','Motor'),)))),
  (r'^security/(?P<object_id>\d+)/$',         'vulture.views.edit_security'),
