...
urlpatterns = patterns('',
  ...
  (r'^plugincontent/$',                              'vulture.views.vulture_object_list_adm', dict({'queryset': Plugincontent.objects.all()}, template_name='vulture/generic_list.html', extra_context = dict(category='Web Applications', name='Plugin Content Rewrite', url='/plugincontent', noname=True, fields=(('pattern','Pattern'), ('type','Type'), ('options','Options'), ('options1','Options1'))))),
  ...
  (r'^pluginheader/$',                              'vulture.views.vulture_object_list_adm', dict({'queryset': Pluginheader.objects.all()}, template_name='vulture/generic_list.html', extra_context = dict(category='Web Applications', name='Plugin Header Input', url='/pluginheader', noname=True, fields=(('pattern','Pattern'), ('type','Type'), ('options','Options'), ('options1','Options1'))))),
